...
def setup_playwright():
    """
    A cached function to run the installation logic. Streamlit's cache_resource
    ensures this block of code is executed only once when the app boots up.
    """
    st.write("Verifying and installing Playwright dependencies...")
    try:
        # The --with-deps flag is crucial: it installs both the browser binary
        # and the necessary OS libraries.
        command = [sys.executable, "-m", "playwright", "install", "--with-deps", "chromium"]
        with st.spinner("This may take a moment on the first run..."):
...
# Call the setup function to ensure the environment is ready before proceeding.
setup_complete = setup_playwright()


# ===================================================================
# 3. DATA SCRAPING & PROCESSING FUNCTIONS (Cached for performance)
# ===================================================================
